...
class Mailer {
    protected $_ci;
    protected $email_pengirim = 'risnadicoy@gmail.com'; // Isikan dengan email pengirim
    protected $nama_pengirim = 'Rudi Risnadi'; // Isikan dengan nama pengirim
    protected $password = 'rudirisnadi'; // Isikan dengan password email pengirim
